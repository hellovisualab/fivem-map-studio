...
name '${name}'
description 'Custom minimap generated with FiveM Map Studio'
author 'FiveM Map Studio'
version '1.0.0'
...
function clientLua(opts: ExportOptions) {
  return `-- Generated by FiveM Map Studio
...
const serverLua = `-- Generated by FiveM Map Studio
...
Generated with **FiveM Map Studio** from project "${project.name}".
...
- \`config/project.json\` – full studio project (re-import it in FiveM Map Studio)
