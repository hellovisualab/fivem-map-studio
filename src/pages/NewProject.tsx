            ...
            <div>
              ...
              {Object.values(sources).length > 0 && !Object.values(sources).some((s) => s?.real) && (
                <p className="mb-3 rounded-xl border border-ink-700 bg-ink-850/70 px-3 py-2 text-xs text-ink-400">
                  Presets are stylized previews. Drop your own GTA V minimap textures (one image or the <code className="rounded bg-ink-800 px-1 text-ink-300">minimap_sea_*.dds</code> tiles from OpenIV) into{' '}
